                ...
                <div className="grid lg:grid-cols-2 gap-10 ">
                    ...
                    <div className='lg:px-12'>
                        ...
                        <h2 className='lg:text-52 text-40 leading-[1.2] font-medium text-dark dark:text-white'>
                            Everything about Jupiterrealty homes
                        </h2>
                        ...
                        <div className="my-8">
                            <Accordion type="single" defaultValue="item-1" collapsible className="w-full flex flex-col gap-6">
                                <AccordionItem value="item-1">
                                    <AccordionTrigger>1. Can I personalize my Jupiterrealty home?</AccordionTrigger>
                                    <AccordionContent>
                                        Discover a diverse range of premium properties, from luxurious apartments to spacious villas, tailored to your needs.
                                    </AccordionContent>
                                </AccordionItem>
                                <AccordionItem value="item-2">
                                    <AccordionTrigger>2. Where can I find Jupiterrealty homes?</AccordionTrigger>
                                    <AccordionContent>
                                        Discover a diverse range of premium properties, from luxurious apartments to spacious villas, tailored to your needs.
                                    </AccordionContent>
                                </AccordionItem>
                                <AccordionItem value="item-3">
                                    <AccordionTrigger>3. What steps to buy a Jupiterrealty?</AccordionTrigger>
                                    <AccordionContent>
                                        Discover a diverse range of premium properties, from luxurious apartments to spacious villas, tailored to your needs.
                                    </AccordionContent>
                                </AccordionItem>
