    ...
    <section className='!py-0'>
      <div className='bg-gradient-to-b from-skyblue via-lightskyblue dark:via-[#4298b0] to-white/10 dark:to-black/10 overflow-hidden relative'>
        <div className='container max-w-8xl mx-auto px-5 2xl:px-0 pt-32 md:pt-60 md:pb-68'>
          ...
          <div className='hidden md:block absolute top-20 -right-68'>
            <Image
              src={'/images/hero/dholera.png'}
              alt='heroImg'
              width={1082}
              height={1016}
              priority={false}
        ...
        <div className='md:absolute bottom-0 md:-right-68 xl:right-0 bg-white dark:bg-black py-12 px-8 mobile:px-16 md:pl-16 rounded-2xl md:rounded-none md:rounded-tl-2xl mt-24'>
          <div className='grid grid-cols-2 sm:grid-cols-4 md:flex gap-16 md:gap-24 sm:text-center dark:text-white text-black'>
            ...
            <div className='flex flex-col sm:items-center gap-3'>
              <Image
                src={'/images/hero/expressway.png'}
                alt='sofa'
                width={32}
                height={32}
                className='block dark:hidden'
